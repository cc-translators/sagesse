...
\dvday{Satisfaction de l\ap{}Âme Affamée }
...
\dvlettrine{A}{fin que nous sachions} ce que c'est qu'être juste,
...
Viens, mon bien-aimé\dots{}
 Au petit matin nous irons aux vignobles, voir si la vigne bourgeonne,
 si la fleur s'ouvre, si les grenadiers fleurissent.
 Là, je te donnerai ma tendresse.
}{\ibibleverse{Ct}(7:12-13)}

\dvlettrine{D}{ésirant se retrouver dans l'intimité avec lui,}
...
\dvlettrine{E}{st-il surprenant} que nous soyons impatients
...
\dvquote{
Quoi donc ! Tu es tombé du ciel, Astre brillant, fils de l'aurore ! \dots{}
 Tu disais en ton cœur~: Je monterai au ciel, J'élèverai mon trône
 au-dessus des étoiles de Dieu\dots{}
 Je serai semblable au Très-Haut.
 Mais tu as été précipité dans le séjour des morts\dots{}
}{\ibibleverse{Is}(14:12-15)}

\dvlettrine{N}{ous appartenons tous} à l'une de deux catégories.
...
Père, nous te remercions de nous avoir appelés et choisis.
 ...
 Puisse Ton Saint-Esprit continuer à nous façonner. 
}{\DlNdJ}
...
\dvlettrine{C}{ertains d'entre vous} se trouvent en ce moment
 en pleine tourmente.
...
\dvlettrine{L}{orsque la puissante armée assyrienne} a menacé d'assiéger
...
\dvlettrine{I}{sraël avait cessé} de tenir compte de Dieu.
...
\dvday{Quand Dieu dit \og Non \fg{}}
...
\dvlettrine{E}{st-ce vraiment de l'amour} que de donner à vos enfants
...
Père, nous te remercions pour le don de la paix,
 ...
 dans nos cœurs. Apprends-nous à garder nos cœurs et nos pensées
...
La parole de l'Éternel me fut adressée en ces mots~:
 ...
 Je t'avais consacré; Je t'avais établi prophète pour les nations. \fg{}
}{\ibibleverse{Jr}(1:4-5)}

\dvlettrine{L}{a vie et le ministère de Jérémie} ont commencé
...
\dvbox{
Dieu confie à chacun de vous une œuvre à accomplir pour Sa gloire. 
}
...
\dvquote{
Pourtant malgré tout cela, la perfide Juda, sa sœur,
 n'est pas revenue vers moi de tout son cœur; c'était faux,
 \ocadr oracle de l'Éternel.
}{\ibibleverse{Jr}(3:10)}

\dvlettrine{J}{uda fut témoin de la destruction du royaume du nord,} Israël,
 ...
 intérieurement leurs cœurs n'avaient pas \typo{« pas » manquant}
 été touchés. 
...
\dvprayer{
Père, donne-nous un cœur pur
 \ocadr un cœur qui Te soit complètement consacré.
...
\dvday{Le Chemin d\ap{}Autrefois}
...
\dvlettrine{I}{sraël était dans un état désastreux.}
 Ses prophètes annonçaient des mensonges, disant au peuple~: \punct{deux-points}
...
\dvprayer{
Père, pardonne-nous nos errements. Nous te demandons de nous ramener
...
\dvlettrine{L}{'argile est un des matériaux} les plus communs sur la terre.
...
Si vous vous soumettez à Lui, vous allez progressivement voir apparaître
 la forme que Dieu façonne en vous. 
}
...
\dvlettrine{Q}{uelquefois,} quand nous vivons des échecs
...
Vous traversez peut-être des expériences déplaisantes,
 mais ça ne signifie pas que les pensées de Dieu
...
Merci, Père, de ce que Tes pensées envers nous sont des pensées de paix
 et d'amour. Aide-nous à fixer nos yeux sur l'éternité et non pas
...
\dvday{Bouleversements Amenés par Amour}
...
\dvlettrine{M}{oab,} qui se trouvait être situé
