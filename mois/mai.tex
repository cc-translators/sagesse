...
\mainthemeindex{Dieu!volonte@volonté de \sim}
\themeindex{direction}
...
Notre préférence serait d'entendre d'abord la volonté de Dieu, \punct{virgule}
 pour alors pouvoir décider si elle nous plaît ou pas. \punct{point}
...
Vivez simplement en Lui étant consacré; faites-Lui confiance
 ...
 ou comme le traduisent d'autres versions\frcolon{} \punct{deux-points}
...
\jrnlday{Le sentier du juste}

\mainthemeindex{justice}
...
Jésus ne promet pas que nous allons vivre pour toujours
 ...
 dans la présence de Dieu, \punct{virgule}
...
\dvquote{
Telle voie paraît droite devant un homme, mais à la fin,
 c'est la voie de la mort.
...
\dvbox{
Les sages vivent pour des buts bien déterminés.
}
...
Vous sentez-vous dépassé aujourd'hui? Inquiet \fixme{Majuscule à \Og inquiets \Fg}
 ou incertain? Courez à Jésus. \typo{Pas de tiret}
...
\mainthemeindex{amitie@amitié}
\themeindex{Dieu!amour de \sim}

\dvquote{
L'homme qui a des amis doit se montrer aimable;
 et il y a un ami qui s'attache plus qu'un frère.
...
Père, nous Te remercions pour Ton Fils unique qui a offert Sa vie
 ...
 nous puissions nous aussi être appelés les amis de Dieu.\\
