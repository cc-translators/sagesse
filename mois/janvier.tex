...
\dvlettrine{P}{ourquoi} Dieu voudrait-Il nous créer à Son image? \\[1ex]
...
\dvprayer{Père, merci car en contemplant Ta gloire, nous sommes transformés en Ton
 image par l'Esprit Saint \suggest{ou Esprit-Saint?}
 qui agit en nous.}{\Amen}
...
\dvprayer{
Père, alors que Ton Esprit Saint \suggest{ou Esprit-Saint?}
 nous conduit sur Ton chemin,
...
\dvday{Sur des Ailes d\ap{}Aigle}
...
\dvlettrine{O}{ù demeure} Dieu ? \\[1ex]
...
\dvlettrine{S}{elon vous}, Dieu est comment? \\[1ex]
...
\dvday{Le Sang de l\ap{}Expiation}
