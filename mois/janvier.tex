...
\themeindex{salut}
\themeindex{jardin d'Éden}
\themeindex{libre arbitre}
\index{choix|see{libre arbitre}}
\themeindex{Jesus@Jésus!mission de \sim}
...
\lettrine{D}{ans} les temps qui ont précédé le déluge, l'humanité s'était
 ...
 que Dieu ayant regardé la situation, déclara\frcolon{} \Og Mon esprit ne débattra pas
...
\index{sang!\sim~de Jésus|see{Jésus}}
\themeindex{Jesus@Jésus!sang de \sim}
\themeindex{peche@péché}
...
\themeindex{salut}
\themeindex{Dieu!sainteté de \sim}
\themeindex{Bible}
\themeindex{peche@péché}
...
\themeindex{direction}
\themeindex{Jesus@Jésus!Bon Berger}
...
\themeindex{vie chrétienne}
\themeindex{Dieu!fidélité de \sim}
