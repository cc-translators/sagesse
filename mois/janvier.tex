...
\dvlettrine{D}{ans} les temps qui ont précédé le déluge, l'humanité s'était
 ...
 toujours avec l'homme \fg{} (\bibleverse{Gn}(6:3) \KJF{}). 
...
Nous vivons, nous aussi, dans un monde rempli de violence et de corruption.
 ...
 \bibleverse{Mt}(24:37) nous dit~: \og Comme aux jours de Noé ainsi en sera-t-il
...
La vie chrétienne n'est pas facile non plus.
 ...
 quelque chose d'étrange \fg{} (\bibleverse{IP}(4:12)).
...
\og Le péché ne dominera pas sur vous \fg{} (\bibleverse{Rm}(6:14)).
 Je n'ai plus à être dirigé par le péché.
 Je ne suis plus en sujétion au péché en raison de la puissance
...
Paul a déclaré~:
 ...
 et l'Esprit en a de contraires à la chair \fg{} (\bibleverse{Ga}(5:17)).
