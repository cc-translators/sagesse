...
Dans cette situation très inconfortable, Paul et Silas
 ont fait ce qui leur paraissait comme la seule chose sensée:
...
Le but réel de la tempête n'allait être révélé à Paul que beaucoup plus tard.
 ...
 C'est dans ces moments-là que nous devons nous souvenir des paroles du Seigneur:
...
\index{bon!\sim{}ne Nouvelle|see{Évangile}}
...
\index{resurrection@résurrection!\sim~de Jésus-Christ|see{Jésus-Christ}}
\themeindex{Jesus@Jésus-Christ!intercession de \sim}
...
\index{parousie|see{retour}}
\index{retour!\sim~de Jésus-Christ|see{Jésus-Christ}}
...
\dvquote{%
Pour moi, frères, ce n'est pas comme à des hommes spirituels
...
\themeindex{communion!Sainte Cène}
...
L'Amour \ocadr Paul a dit: \punct{deux-points}
 ...
 l'amour \emph{agapé} \suggest{emph} décrit dans ce chapitre:
