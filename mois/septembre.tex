...
\dvbox{
L'argile ne peut que se laisser façonner.
}
...
Père, alors que nous tournons à toute allure sur le tour,
 ...
 Façonne-nous en des vases qui T'amèneront gloire et honneur.
}{\DlNdJ}
...
Le fait que \og Ses voies sont incompréhensibles \fg{}
 ...
 Mais comme Dieu l'a dit à Ésaïe~: \punct{deux-points}
...
\lettrine{Q}{uelle heure est-il?}
 Paul répondait~: \punct{deux-points}
...
\dvquote{
Mais l'homme naturel ne reçoit pas les choses de l'Esprit de Dieu [\dots{}]
...
Et cependant Paul a dit~: \punct{deux-points}
...
Les chrétiens charnels\typo{charnels} ont reçu Jésus comme leur Sauveur
...
Paul a été battu, emprisonné, lapidé et finalement décapité
 pour la cause de Jésus-Christ. Le monde dirait~: \typo{deux-points}
...
Comment se fait-il que si vous donnez votre vie au service de votre pays
 on vous traite en héros\grammar{en héros},
...
Adolescent, j'ai fortement été inspiré par un homme
 qui avait l'habitude de dire~: \typo{deux-points}
...
N'essayons pas de discerner si quelque chose est bien ou mal.
 ...
 demandons-nous plutôt~: \og \punct{guillemets}
...
Une division s'était développée dans l'église de Corinthe.
...
Il y aura toujours des snobs intellectuels.
 ...
 Mais le prophète Ésaïe a écrit~: \punct{deux-points}
 \og Ta sagesse et ta science t'ont trompé;
 tu as dit dans ton c\oe{}ur~: \punct{deux-points, majuscule}
...
\lettrine{P}{aul} venait juste de reprendre
 ...
 Et il leur a donc dit~: \punct{deux-points}
...
\lettrine{V}{oici} les trois pieds sur lesquels
...
L'Amour \ocadr Paul a dit~: \punct{deux-points}
...
\lettrine{L}{es choses} étaient devenues incontrôlables
 ...
 leurs cultes dans le plus grand désordre en disant~: \punct{deux-points}
...
\dvprayer{
Père, nous Te remercions de ce que nous avons reçu Ta paix
...
Les \og gens bien \fg{} souffrent vraiment.
 ...
 Nous pouvons dire~: \punct{deux-points}
...
Pourquoi est-il si difficile de vivre une vie de victoire en Christ?
 ...
 Les Écritures disent~: \punct{deux-points}
