...
\mainjrnlday{Avec vous dans la~fournaise}
...
Ne vous créez pas des\suggest{de} problèmes. Soumettez-vous\grammar{tiret manquant}
 plutôt à Celui qui vous aime.
 Vous pouvez y arriver volontairement ou vous pouvez y arriver en sentant
 le poisson \ocadr mais vous allez vous rendre\suggest{vous rendre}
