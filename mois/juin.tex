...
\diaryday{De la dépression à~l'espoir}
...
\diaryday{Inspiration plutôt que~transpiration}
...
\diaryday{Avec vous dans la~fournaise}
...
\diaryday{Avec facilité ou~avec~difficulté}
...
\diaryday{S'occuper des affaires du~Roi}
...
\diaryday{Prépare-toi à~rencontrer~Dieu}
...
\diaryday{Possédez vos~possessions}
...
L'Esprit de Dieu n'est restreint en aucune fa\c{c}on.
 ...
 Le Saint-Esprit parle à nos c\oe{}urs\frcolon{} \punct{deux-points}
...
\diaryday{Qui est un Dieu comme~notre~Dieu?}
...
\diaryday{Confiez-vous en~l'Éternel}
...
\diaryday{Quand Dieu garde le~silence}
...
Habacuc était frustré. Israël avait tourné le dos à Dieu.
 La nation était dans un chaos moral. Inquiet, Habacuc s'est écrié\frcolon{} \punct{deux-points}
...
\diaryday{Dieu se réjouit à~notre~sujet}
...
\diaryday{Chante et réjouis-toi}
...
\diaryday{Déplacer les~montagnes}
