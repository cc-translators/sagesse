...
\lettrine[findent=-0.1em]{L}{a Bible} enseigne que la tentation \typo{la tentation} tombe généralement
 dans l'un des trois domaines suivants: la convoitise de la chair,
...
\dvbox{%
C'est toujours le c\oe{}ur de la tentation: laisser la chair dominer l'esprit. 
}
...
Pierre sortit de la barque et marcha sur les eaux pour aller vers Jésus.
 ...
 comme il commen\c{c}ait à enfoncer il s'écria: Seigneur, sauve-moi!
...
Pierre, l'intrépide \suggest{intrépide} comme à son habitude, dit: \punct{deux-points}
...
Le pardon envers les autres est un préalable si nous voulons
 ...
 Quelques versets plus loin, Il a ajouté: \punct{deux-points}
