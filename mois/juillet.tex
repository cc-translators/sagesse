...
%\jrnlday{\mbox{Prisonniers~de~l'Espérance}}
\jrnlday{Captifs~de~l'espérance}
\suggest{Captifs au lieu de Prisonniers -- qui ne tient pas}

\mainthemeindex{esperance@espérance}
...
\jrnlday{Une alliance\\ devant Dieu}

\themeindex{alliance}
\themeindex{mariage}
\mainthemeindex{divorce}
...
\jrnlday{Repentez-vous}

\mainthemeindex{repentance}
\themeindex{pardon}
...
\dvprayer{
Père, que Ton Saint-Esprit nous parle du besoin d'une repentance véritable.
...
\jrnlday{La tentation}

\mainthemeindex{tentation}
...
Père, nous confessons que, trop souvent, nous avons échoué,
 ...
 et purifie-nous. Soyons gouverné par Ton Esprit Saint
...
\jrnlday{Pas de soucis}

\mainthemeindex{inquietude@inquiétude}
\themeindex{foi}
\themeindex{priorites@priorités}
...
Père, aide-nous à vivre par ces principes spirituels que Tu as explicité
 pour nous. Aide-nous à parvenir au point où dans nos vies il n'y a plus rien
...
\jrnlday{Impardonnable}

\mainthemeindex{pardon}
\themeindex{blaspheme@blasphème}
\themeindex{peche@péché}
...
Père, nous connaissons des gens autour de nous qui ont dit \Og non \Fg{}
 ...
 Mais Tu les aimes en dépit de leur rébellion. Puissent-ils entendre
...
\jrnlday{Fixez vos yeux sur Jésus}
...
Pierre, l'intrépide \suggest{intrépide} comme à son habitude, dit\frcolon{} \punct{deux-points}
...
\themeindex{Fils!\sim~de David}
\mainthemeindex{Dieu!silence de \sim}
\index{silence!\sim~de Dieu|see{Dieu}}
\themeindex{foi}
\themeindex{patience}
...
Quelquefois, Dieu est simplement en train d'attendre.
 ...
 Démontrez votre foi en attendant\suggest{en attendant}
 les paroles que vous espérez\suggest{espérez, pour ne pas répéter}
...
Le pardon envers les autres est un préalable si nous voulons
 ...
 à ceux qui nous ont offensés. \Fg{} (\ibibleverse{Mt}(6:12)).
 Quelques versets plus loin, Il a ajouté\frcolon{} \punct{deux-points}
...
\jrnlday{Les jours de Noé}

\themeindex{Fils!\sim~de l'homme}
\themeindex{Noe@Noé}
\themeindex{mechancete@méchanceté}
...
\jrnlday{Le fidèle serviteur}

\mainthemeindex{fidelite@fidélité}
\themeindex{talent}
...
Tout ce que j'ai fait et tout ce que je fais dans ma vie
 ...
 \Og Bien joué. \Fg{} \suggest{Bien joué}
...
%\jrnlday{Le Chemin Qui Mène au Reniement}
\jrnlday{Le chemin vers le reniement}

\mainthemeindex{reniement}
...
\dvbox{
Il suffit de quelques erreurs pour
 vous faire passer
...
\mainthemeindex{Jesus@Jésus-Christ!toucher de \sim}
\mainthemeindex{Jesus@Jésus-Christ!compassion de \sim}
\index{toucher!\sim~de Jésus-Christ|see{Jésus-Christ}}
\index{compassion!\sim~de Jésus-Christ|see{Jésus-Christ}}
...
\jrnlday{Le complot contre Jésus}
...
\jrnlday{Toucher Jésus}

\mainthemeindex{toucher}
\themeindex{Jesus@Jésus-Christ!pouvoir de \sim}
...
\mainthemeindex{incredulite@incrédulité}
\themeindex{foi}
\themeindex{miracle}
...
Quand nous ressassons nos blessures et offenses, nos corps en pâtissent.
 Peu importe que vous soyez justifié dans votre colère.
...
Certaines blessures sont si profondes qu'il nous semble impossible
 ...
 l'auteur des torts causés \ocadr tout comme Il vous a pardonné
 quand vous ne le méritiez pas, que vous n'étiez pas digne de Son pardon.
...
\lettrine{D}{ieu} aime marcher dans Sa vigne.
...
À l'opposé des fruits, on trouve les \oe{}uvres.
 Le fruit se développe naturellement et résulte d'une relation,
 alors que les \oe{}uvres sont ces choses qui sont produites par les efforts,
 l'organisation et la coordination.

Le Seigneur n'est pas intéressé de venir dans une fabrique industrielle,
 d'entendre le bruit assourdissant des machines et le vacarme de l'acier qu'on martelle,
 de trouver la crasse habituellement trouvée dans des endroits
 aussi grouillants d'activité.
 Le Seigneur veut venir dans Son jardin, pour goûter et apprécier
 les fruits qui s'y trouvent.
...
\jrnlday{Le retour du roi}

\themeindex{Fils!\sim~de l'homme}
\mainthemeindex{Jesus@Jésus-Christ!retour de \sim}
\themeindex{temps!fin des \sim}
...
Les Juifs se méprenaient sur Jésus,
 parce qu'ils se focalisaient sur seulement la moitié des prophéties
 de l'Ancien Testament concernant le Messie à venir.
 Ils attendaient l'arrivée d'un royaume glorieux, \punct{virgule}
 ...
 la première pour faire un sacrifice pour le péché des hommes;
 la seconde pour régner dans la gloire, la majesté et la puissance.
...
Nous devrions guetter le retour de notre Seigneur.
 ...
 \ocadr de sorte que s'Il venait aujourd'hui, \punct{virgule}
 il ne nous resterai aucun travail encore inachevé.
...
\jrnlday{Force dans l'Esprit}

\themeindex{veille}
\themeindex{priere@prière}
\themeindex{Jesus@Jésus-Christ!humanité de \sim}
\themeindex{chair}
...
\lettrine{N}{ous} oublions souvent l'humanité de Jésus.
 ...
 et nous en voyons la preuve dans le jardin de Gethsémané, \punct{virgule}
 où Il fit face au plus grand défi de Sa vie.
...
La chair n'est pas digne de confiance.
...
\jrnlday{La tragédie de l'incrédulité}

\mainthemeindex{incredulite@incrédulité}
\themeindex{Jesus@Jésus-Christ!resurrection@résurrection de \sim}
...
Les disciples auraient dû s'attendre à Sa résurrection.
 ...
 On aurait pensé \grammar{concordance}
 qu'en ce troisième jour, ils auraient été euphoriques
 ...
 Le doute les garde dans les pleurs.
 Et ils continuent à \suggest{à} porter
...
\jrnlday{La grandeur de Jésus}

\themeindex{Jesus@Jésus-Christ!grandeur de \sim}
...
Père, nous sommes en admiration devant Ta nature \ocadr Ta majesté,
 Ta puissance, Ta gloire, Ta sagesse, Ta patience \fcadr{}
 et en admiration devant Ta beauté.
 Puisses-Tu vite venir pour nous, Seigneur Jésus.
}{\DlPNdJ}
...
\jrnlday{Préparez le chemin du~Seigneur}
...
\themeindex{direction}
\themeindex{tentation}
\themeindex{Esprit-Saint!marche selon l'\sim}
...
\jrnlday{Puissance pour vaincre la~tentation}
