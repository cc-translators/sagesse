...
\jrnlday{Notre capacité}

\mainthemeindex{Dieu!capacité de \sim}
...
\lettrine{P}{aul} venait de dire aux Corinthiens\frcolon{} \punct{deux-points}
 ...
 vous pouvez vous demander\frcolon{} \punct{deux-points}
 \Og Qui est capable d'être à la hauteur de ces choses? \Fg{},
 mais \typo{Mais} comme Paul le déclare\frcolon{} \punct{deux-points}
...
\dvbox{
Reconnaître votre incapacité vous conduit à dépendre
 de la capacité infinie de Dieu.
}
...
\jrnlday{Voir l'invisible}

\themeindex{monde!spirituel}
\index{spirituel!monde \sim|see{monde}}
\themeindex{monde!matériel}
\index{matériel!monde \sim|see{monde}}
...
\jrnlday{Perfectionner la sainteté}
...
\dvbox{
Quelle extraordinaire vérité\frcolon{} vous êtes un enfant de Dieu!
}

Ensuite, nous devons nous séparer du monde incrédule qui nous entoure.
 Dieu veut que Son peuple soit saint. Le Seigneur dit\frcolon{} \punct{deux-points}
...
\dvprayer{
Dieu, aide-moi à être pur dans mes pensées, dans mon c\oe{}ur
...
\jrnlday{Les richesses de Sa grâce}

\themeindex{Dieu!grace@grâce de \sim}
\themeindex{richesse}
\themeindex{Dieu!richesses de \sim}
\themeindex{pauvrete@pauvreté}
\themeindex{heritage@héritage}
\themeindex{joie}
\themeindex{misericorde@miséricorde}
\themeindex{paix}
\themeindex{Jesus@Jésus-Christ!paix de \sim}
\index{Christ|see{Messie}}
\themeindex{justice}
...
\lettrine{Q}{ui} pourra jamais estimer les richesses de Dieu?
 Dans le \ibibleverse{Ps}(50:10), Il nous dit\frcolon{} \punct{deux-points}
...
Jésus a prié\frcolon{} \punct{deux-points}
...
Les richesses que Jésus désire partager avec vous sont des richesses
 éternelles qui ne peuvent pas être mesurées par des moyens temporels tels que l'or ou l'argent.
}
...
\jrnlday{La grâce toute-suffisante}

\mainthemeindex{grace@grâce}
\themeindex{chair}
\themeindex{souffrance}

\dvquote{
Et Il m'a dit\frcolon{}
...
La souffrance développe une profonde relation avec Dieu qui semble
 ...
 Et il a écrit\frcolon{} \punct{deux-points}
...
\jrnlday{Grâce et paix}

\mainthemeindex{grace@grâce}
\mainthemeindex{paix}
\themeindex{merite@mérite}
...
\lettrine{P}{aul} a pris la salutation grecque \emph{charis}
 ...
 hébraïque \emph{shalom} qui veut dire \Og paix \Fg{}\frcolon{} \punct{deux-points}
 \Og Grâce et paix. \Fg{}
 Cette salutation est utilisée dix-sept fois dans le Nouveau Testament,
 toujours dans cet ordre\frcolon{} \punct{deux-points} \Og grâce et paix. \Fg{}
...
C'est \c{c}a, \punct{virgule} la grâce.

\dvrule

\dvprayer{
Merci, Seigneur, pour la merveilleuse paix et la compréhension des choses
 où Tu gardes nos c\oe{}urs et nos pensées en raison de Ta grâce.
}{\DlNdJ}
...
\jrnlday{Merveilleuse délivrance}

\mainthemeindex{delivrance@délivrance}
\themeindex{Dieu!Fils de \sim}
\themeindex{chair|crucifixion de la \sim}
\themeindex{foi}
\themeindex{crucifixion|\sim~de la chair|see{chair}}
...
Quand la tentation surgit, nous pouvons considérer cette vieille nature
 ...
 tout de suite ramener ce péché à la croix et dire\frcolon{} \punct{deux-points, majuscule}
...
\jrnlday{La malédiction du péché}

\mainthemeindex{peche@péché}
\themeindex{loi|\sim~de Moïse}
\mainthemeindex{malediction@malédiction}
\themeindex{Croix}
...
Christ nous a rachetés de la malédiction de la loi,
 étant devenu malédiction pour nous \ocadr car il est écrit\frcolon{}
...
\lettrine{L}{a loi} que Dieu avait donnée aux enfants d'Israël
 ...
 Comme Jacques l'a fait remarquer\frcolon{} \punct{deux-points}
...
Ainsi donc, nous sommes coupables. Nous méritons la mort.
 Cependant,\punct{virgule} Jésus a pris nos péchés et Il est mort à notre place.
 Non seulement cela signifie que nous n'avons plus\missing{plus}  à souffrir de la malédiction
 de la loi, mais cela signifie aussi que nous sommes bénis.
 Son sacrifice nous a amené les bénédictions d'Abraham.
 Car nous lisons\frcolon{} \punct{deux-points}
...
\mainthemeindex{adoption}
\mainthemeindex{Dieu!enfant de \sim}
\themeindex{benediction@bénédiction}

\dvquote{
Et parce que vous êtes des fils, Dieu a envoyé dans nos c\oe{}urs
 l'Esprit de son Fils, qui crie\frcolon{} \Og Abba ! Père ! \Fg{}
}{\ibibleverse{Ga}(4:6)}
...
\lettrine{J}{e} ne suis pas un fils de Dieu par la naissance naturelle;
 ...
 nous crions\frcolon{} \Og Abba ! Père ! \Fg{} (\ibibleverse{Rm}(8:14-15)).
 \punct{On peut utiliser des guillemets fran\c{c}ais emboîtés, et on ne les ferme qu'une fois}
...
\jrnlday{Œuvre ou fruit?}

\mainthemeindex{oeuvre@\oe{}uvre!\sim~s}
\mainthemeindex{fruit}
\themeindex{amour}
\themeindex{amour!agape@agapé}

\dvquote{
Mais le fruit de l'Esprit est\frcolon{} amour\dots{}
}{\ibibleverse{Ga}(5:22)}

\lettrine{P}{aul} parlait des \oe{}uvres de la chair,
 puis au verset~22, il commence\frcolon{} \punct{deux-points}
...
Le fruit de l'Esprit émane-t-il de votre vie? Demeurez en Lui et laissez Sa parole
...
\jrnlday{Ma gloire, la Croix}

\mainthemeindex{gloire}
\mainthemeindex{Croix}
\themeindex{talent}
...
\jrnlday{Connaître Dieu}

\index{connaissance!de Dieu|see{Dieu}}
\mainthemeindex{Dieu!connaissance de~\sim}
...
\dvbox{
Quand nous commen\c{c}ons à marcher avec Jésus,
...
\mainthemeindex{Dieu!oeuvre@\oe{}uvre de \sim}
\mainthemeindex{Dieu!plan de \sim}

\dvquote{
Nous sommes Son ouvrage, nous avons été créés en Christ-Jésus
 pour des \oe{}uvres bonnes que Dieu a préparées d'avance,
...
\dvbox{
Dieu \oe{}uvre en vous parce que vous êtes Son ouvrage.
...
\lettrine{N}{ous} avons tendance à jauger les obstacles
 ...
 Comme Il l'a dit\frcolon{} \punct{deux-points}
...
Quand le médecin nous dis\frcolon{} \punct{deux-points}
...
Mais, en disant la vérité avec amour, nous croîtrons à tous égards
 ...
 De Lui, le corps tout entier bien ordonné et cohérent,
 grâce à toutes les jointures
...
\lettrine{A}{lors qu'il} sortait de l'église un jour,
 un petit gar\c{c}on se touna vers son Papa \suggest{papa} en lui disant\frcolon{} \punct{deux-points}
...
\dvprayer{
Père, nous voulons devenir tout ce que Tu voudrais que nous soyons.
...
\jrnlday{La conduite du croyant}

\mainthemeindex{conduite}
\themeindex{temps}
...
\jrnlday{La puissance de la prière}
...
Dans le jardin, Jésus a prié pendant que Pierre dormait.
 Quand Jésus l'a réveillé, Il lui a dit\frcolon{} \punct{deux-points}
...
Père, nous Te remercions pour l'arme puissante de la prière par laquelle
 nous pouvons faire tomber les forteresses détenues par Satan dans les vies
...
\jrnlday{Pas de peur devant~la~mort}
...
La vérité, c'est que si les incroyants connaissaient la réalité
 ...
 afin de se retrouver en présence du Seigneur (\ibibleverse{IICo}(5:8)).
...
\jrnlday{Ne vous inquiétez\\ de rien}

\mainthemeindex{inquietude@inquiétude}
\themeindex{priere@prière}
\themeindex{grace@grâce!action de~\sim}
...
Ne vous inquiétez de rien; mais, en toutes choses, par la prière
 ...
 gardera vos c\oe{}urs et vos pensées en Christ-Jésus.
...
Père, merci à Toi pour qui Tu es et pour tout ce que Tu fais pour nous.
 Bénis-nous de Ta paix alors même que nous Te recherchons.
}{\DlNdJ}
...
Nous ne cessons de [\dots{}] demander que vous soyez remplis de la connaissance
 ...
 portez des fruits en toute sorte d'\oe{}uvres bonnes et croissez
...
Paul fait bien \suggest{bien fait remarquer} remarquer dans ce passage
 ...
 que les choses qui sont temporelles. Jean a dit\frcolon{} \punct{deux-points}
...
\jrnlday{Persévérez~dans la~prière}
...
\lettrine{P}{arce qu'ils} étaient sur le point d'être jugés pour leurs péchés,
 les Israëlites ont dit à Samuel\frcolon{} \punct{deux-points}
 \Og Prie pour nous afin que nous ne mourions pas. \Fg{} \punct{Point après guillemet}
 Samuel leur a répondu\frcolon{} \punct{deux-points}
...
Mais peut-être demanderez-vous\frcolon{} \punct{deux-points}
...
\jrnlday{Connus pour notre~amour}

\dvquote{
Nous nous souvenons sans cesse, devant Dieu notre Père,
 de l'\oe{}uvre de votre foi, du travail de votre amour,
...
\dvprayer{
Père, Merci pour la foi que Tu donnes et pour le privilège d'\oe{}uvrer pour Toi.
...
\jrnlday{La puissante Parole~de~Dieu}
...
C'est pourquoi nous rendons continuellement grâces à Dieu de ce qu'en
 ...
 mais comme ce qu'elle est vraiment\frcolon{} la parole de Dieu qui agit en vous
 qui croyez.
...
\dvprayer{
Père, merci pour la puissance de Ta Parole et pour la fa\c{c}on dont Tu
...
\jrnlday{Suppléer à ce qui manque à notre foi}
...
Nous manquons tous de foi dans certains domaines, aussi devons-nous prier\frcolon{} \punct{deux-points}
...
Quand l'Enlèvement arrivera, nous serons pris par surprise.
 ...
 Ce jour va bientôt arriver. Avec un cri, Il dira\frcolon{} \punct{deux-points}
...
Père, Merci pour la glorieuse espérance du retour de notre grand Dieu
 et Sauveur Jésus-Christ. Aide-nous à vivre de fa\c{c}on à ce que nous soyons
...
\lettrine{D}{ans Sa lettre} à l'église de Sardes,
 ...
 de Son retour, Il leur a dit\frcolon{} \punct{deux-points} \Og Veillez ! \Fg{}
...
Dans ce passage, Paul nous dit que c'est la volonté de Dieu \Og qu'en toute
 ...
 Notez qu'Il n'a pas dit\frcolon{} \punct{deux-points}
 \Og En certaines circonstances, rendez grâces\dots{} \Fg{}
 Il a dit\frcolon{} \punct{deux-points} \Og En toute \Fg{}.
...
Il semble que les gens viennent toujours s'opposer à ceux qui essayent
 ...
 et mentir contre vous, ce qui vous conduit à \typo{espace} vous demander\frcolon{} \punct{deux-points}
...
\dvbox{
Les Écritures avertissent de fa\c{c}on répétée que Dieu va juger ses ennemis. 
}
...
Père, aide-nous à tenir ferme pour Jésus-Christ et à nous opposer
 à la vague du mal. Seigneur, aide-nous à vivre d'une fa\c{c}on qui Te plaise.
}{\Amen}
