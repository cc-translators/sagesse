...
\lettrine{A}{lors qu'il} sortait de l'église un jour,
 un petit gar\c{c}on se touna vers son Papa \suggest{papa} en lui disant: \punct{deux-points}
...
\lettrine{D}{ans Sa lettre} à l'église de Sardes,
 Jésus a averti: \punct{deux-points}
...
Il semble que les gens viennent toujours s'opposer à ceux qui essayent
 ...
 et mentir contre vous, ce qui vous conduit à vous demander: \punct{deux-points}
