...
\themeindex{priere@prière}
\themeindex{grace@grâce!action de~\sim{}s}
...
\themeindex{enlevement@enlèvement!\sim~de l'Église}
...
\mainthemeindex{veille}
\themeindex{sobriete@sobriété}
...
\lettrine{D}{ans Sa lettre} à l'église de Sardes,
 Jésus a averti\frcolon{} \punct{deux-points}
...
\mainthemeindex{grace@grâce!action de~\sim{}s}
\themeindex{Dieu!volonte@volonté de \sim}
...
Il semble que les gens viennent toujours s'opposer à ceux qui essayent
 ...
 et mentir contre vous, ce qui vous conduit à vous demander\frcolon{} \punct{deux-points}
