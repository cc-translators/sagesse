...
\dvlettrine{L}{e secret} d'une vie réussie est dans la recherche du Seigneur.
 ...
 et tout cela vous sera donné par-dessus \fg{} (\bibleverse{Mt}(6:33)).
...
Dans le Nouveau Testament, nous lisons \og Il y a un seul Dieu,
 ...
 le Christ-Jésus homme \fg{} (\bibleverse{ITm}(2:5)).
...
Quelquefois, il est nécessaire que Dieu nous donne aussi un bon coup.
 ...
 car le Seigneur corrige celui qu'Il aime \fg{} (\bibleverse{He}(12:5-6)).
...
\dvlettrine{Q}{uand} on a demandé à Jésus~:
 ...
 de toute ton âme et de toute ta pensée \fg{} (\bibleverse{Mt}(22:37)). 
