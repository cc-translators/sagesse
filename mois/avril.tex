...
Néanmoins, la prospérité présente souvent des dangers.
 ...
 Nous lisons au verset \ibiblevs{IICh}(26:16)\frcolon{}
...
Fortifiez-vous et prenez courage! Soyez sans crainte et sans effroi
 ...
 car avec vous il y a plus qu'avec lui\frcolon{} avec lui il y a un bras de chair,
...
Chaque fois qu'il y a un problème, Dieu a toujours un remède.
 ...
 Mais soyez prévenus\frcolon{} si vous refusez le remède de Dieu,
...
\lettrine{L}{es voisins} d'Israël ont envoyé cette lettre à Artaxerxès
 ...
 Ils disaient\frcolon{} \Og Nous croyons que ces gens vont vous déshonorer.
...
Esdras ne pouvait pas croire que le peuple puisse oublier Dieu si rapidement.
 Choqué, et à court de mots, il pria\frcolon{} \Og Seigneur, je n'ai aucune excuse.
...
\jrnlday{Prière pressante}

\dvquote{
Le roi me dit\frcolon{} \Og Au fait, que demandes-tu donc ? \Fg{}
...
Quand le roi remarqua que Néhémie n'était pas dans sa bonne humeur habituelle,
 il lui demanda\frcolon{} \Og Pourquoi es-tu aussi triste? \Fg{}
...
Le roi lui demanda donc\frcolon{} \Og Qu'attends-tu de moi? \Fg{}
...
Si vous n'avez pas de relation avec Dieu, il n'y a qu'une seule prière
 qui l'intéresse, à savoir\frcolon{}
...
\jrnlday{Quand l'opposition apparaît}
...
\jrnlday{Le Haman dans nos vies}
...
En typologie\NdT{\emph{typologie biblique}\frcolon{}
...
\jrnlday{Cri du c\oe{}ur pour un médiateur}
...
C'est un fait avéré\frcolon{} Tout ce que nous semons, nous le récoltons.
 ...
 Comme le disent les informaticiens\frcolon{}
 \Og Ordures en entrée; Ordures en sortie. \Fg{}
 Ou pour parler comme en mathématiques\frcolon{} rien plus rien égale rien. 
...
\lettrine{I}{l y avait} beaucoup de choses que Job ne savait pas\frcolon{}
 ...
 Mais Job savait une chose\frcolon{} \Og Mon Rédempteur est vivant. \Fg{}
...
Quand Job a tourné son regard vers Dieu, sa vision de lui-même a changé.
 Il a dit alors\frcolon{} \Og Je reconnais avoir eu tort et je m'humilie en m'asseyant
...
Vous vous vantez peut-être de vos réussites et succès.
 Mais notez bien ceci\frcolon{} quand vous voyez un homme orgueilleux,
...
Parce que quand vous voyez vraiment Dieu,
 ...
 un c\oe{}ur qui s'écrie\frcolon{}
...
Les Évangiles nous disent qu'après que Jésus a
 ...
 Et de l'obscurité est monté un cri de la part de l'Homme de la croix du milieu\frcolon{}
 \Og Mon Dieu, Mon Dieu, pourquoi M'as-tu abandonné ? \Fg{}.
 Le cri de Jésus nous ramène au \ibibleverse{Ps}(22:).
 Mais il nous pose et nous impose la question\frcolon{}
...
Au moment où Dieu a mis mon péché \ocadr{}et le péché du monde entier\fcadr{}
 sur Jésus-Christ, la conséquence inévitable s'est produite\frcolon{}
...
\jrnlday{Le Seigneur\\ est mon berger}
...
Au verset \ibiblevs{Ps}(23:4) de ce psaume, David déclare\frcolon{}
...
\jrnlday{La lourde main du Seigneur}
...
J'ai de bonnes nouvelles pour vous. Dès l'instant où David a dit\frcolon{}
 \Og Je reconnais mon péché, je le confesse \Fg{} (\ibibleverse{Ps}(32:5)),
 Dieu l'a pardonné.
 Et vous pouvez être pardonnés tout aussi rapidement.
 La première lettre de Jean nous dit\frcolon{}
...
\lettrine{D}{ans} notre vie ici-bas, nous sommes enclins
 ...
 les versets \ibiblevs{Ps}(37:5-7) de ce psaume\frcolon{}
...
David nous dit que lorsque nous remettons nos problèmes à Dieu,
 deux choses se produisent\frcolon{} Il agit, c'est-à-dire qu'Il accomplit
...
Le psalmiste déclare que la personne qui se confie au Seigneur
 ...
 qui vous créent du souci. Rappelez-vous\frcolon{} remettez cela à Dieu,
...
\jrnlday{Le remède à la dépression}
...
\lettrine{E}{n langage moderne,} on pourrait traduire ce verset par\frcolon{}
...
Mais au milieu de cette dépression, David se rappelle de la solution\frcolon{}
...
Quand David a péché \ocadr et c'étaient des péchés de la pire espèce\frcolon{}
...
Peut-être qu'aujourd'hui, vous éprouvez de la culpabilité.
 ...
 La solution est simple\frcolon{} invoquez Dieu qui est miséricordieux
...
\jrnlday{Remets ton fardeau à l'Éternel}
...
\lettrine{O}{n pense} que David a écrit ce psaume quand son fils,
 ...
 Mais il s'est alors repris en se disant\frcolon{}
...
David a fait preuve de sagesse en remettant son problème à Dieu.
 Le prophète Ésaïe a dit\frcolon{}
...
\dvquote{
Du bout de la terre, je crie à toi, quand le c\oe{}ur me manque;
 conduis-moi sur ce rocher, qui est trop élevé pour moi.
}{\ibibleverse{Ps}(61:2) \Ostervald{}}
...
\lettrine{T}{ôt ou tard,} nous allons tous nous retrouver confrontés
 ...
 il est important de se rappeler cette vérité fondatrice\frcolon{} Dieu est bon.
...
Trop souvent, au sein de notre douleur, nous pensons l'inverse.
 ...
 et nous nous plaignons\frcolon{}
...
La lecture de ce psaume semble indiquer que le psalmiste traversait
 ...
 Vers la fin du psaume, il déclare\frcolon{}
...
\jrnlday{Unis mon c\oe{}ur}

\dvquote{
Éternel, enseigne-moi ta voie, je marcherai dans ta vérité;
 range mon cœur à la crainte de ton nom.
}{\ibibleverse{Ps}(86:11) \Ostervald}

\lettrine{Q}{uand} on a demandé à Jésus\frcolon{}
...
Jésus a dit à l'église d'Éphèse\frcolon{}
 ...
 Il a déclaré dans le verset suivant\frcolon{}
 ...
 Jésus a continué en disant\frcolon{} \Og Repens-toi! \Fg{} Faites demi-tour!
 Demandez à Dieu de vous pardonner pour la froideur que vous avez laissée
 s'installer dans la relation. Puis Jésus a dit\frcolon{}
...
Et quand vous revenez dans une pleine communion avec Lui,
 suivez l'exemple de David\frcolon{}
...
Mais les méchants méprennent Sa patience pour de la faiblesse.
 Ils blasphèment contre Lui\frcolon{}
 \Og Dieu sait-Il ? A-t-Il vu ? Entend-Il vraiment ? \Fg{}
 Ils supposent que la réponse est\frcolon{} \Og Non \Fg{},
...
S'adressant aux sept églises des chapitres \ibiblechvs{Ap}(2:)
 ...
 Jésus a adressé le même avertissement à chacune d'entre elles\frcolon{}
