...
\dvday{Maintenez-vous dans l\ap{}Amour de Dieu}
...
\dvlettrine{D}{'après les apparences extérieures,}
...
\og Rappelle-toi donc d'où tu es tombé, repens-toi
 et pratique tes premières œuvres \fg{} (\bibleverse{Ap}(2:5)).
...
\dvlettrine{P}{ourquoi suis-je ici?}\\
...
Paul a écrit~: \punct{deux-points}
 ...
 selon son dessein bienveillant \fg{} (\bibleverse{Ph}(2:13)).
...
\dvlettrine{D}{ans l'Ancien Testament,}
...
Ce n'est plus qu'une question de temps avant que ce rachat n'arrive
 ...
 Il régnera aux siècles des siècles! \fg{} (\bibleverse{Ap}(11:15)). 
...
\dvlettrine{Q}{uand l'Antéchrist va arriver au pouvoir,} \typo{Antéchrist}
 ...
 à adorer l'Antéchrist, la \og bête \fg{} (\bibleverse{Ap}(13:12-13)). \punct{Point manquant}
...
\dvlettrine{Q}{uel don merveilleux et impressionnant} que celui de la prière!
...
}{\bibleverse{Ap}(9:20-21)}

\dvlettrine{L}{e chapitre 9 de l'Apocalypse} parle des jugements
...
}{\bibleverse{Ap}(12:7-8)}

\dvlettrine{L}{'ennemi auquel nous sommes confrontés} est un des plus puissants
...
Dans le passage d'aujourd'hui, nous le voyons en train de se faire battre
 ...
 des morts ne prévaudront pas contre elle \fg{} (\bibleverse{Mt}(16:18)).
...
}{\bibleverse{Ap}(15:3-4)}

\dvlettrine{I}{l est fort probable} que chacun de ceux qui chantaient
...
}{\bibleverse{Ap}(17:13-14)}

\dvlettrine{Q}{ui serait assez stupide} pour faire la guerre à Jésus-Christ?
...
\dvlettrine{À}{quel fruit ce verset se réfère-t-il?}
...
\dvlettrine{D}{ans sa deuxième lettre aux Corinthiens,}
...
Concernant notre \og propre justice \fg{}, c'est-à-dire la justice
 ...
 (\bibleverse{Is}(64:5)). Quand nous nous présentons à Jésus,
...
\dvlettrine{L}{es gens pensent souvent} qu'ils arrivent à pécher
...
\dvlettrine{Q}{uelquefois les évènements prophétisés par Dieu}
...
Quand Jésus annonçait à Ses disciples les événements \grammar{événements}
...
Qu'est-ce que Dieu affirme être vrai ici dans le vingt et unième chapitre
 ...
 je serai son Dieu, et il sera Mon fils \fg{} (21.6--7). \typo{6--7 et non 6:7}
...
\dvlettrine{C}{e livre merveilleux}
...
\og Que celui qui a soif, vienne. \fg{}
 ...
 ainsi mon âme soupire après Toi, ô Dieu! \fg{} (\bibleverse{Ps}(42:2)).
