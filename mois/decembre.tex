...
\jrnlday{Plus précieux que l'or}
...
\jrnlday{Des ténèbres à~la~lumière}
...
Règle numéro deux\frcolon{} préservez vos lèvres des paroles trompeuses.
...
Règle numéro trois\frcolon{} fuyez ce qui est mal.
 ...
 le bien. Comme Paul l'écrivait aux Éphésiens\frcolon{} \punct{deux-points}
...
Il est triste de voir des gens essayer de retirer de ces dons venus de Dieu,
 ...
 avait pour habitude d'inscrire sur chaque partition\frcolon{} \punct{deux-points}
 \Og À la Gloire de Dieu! \Fg{}

Comme Paul l'a dit\frcolon{} \punct{deux-points}
...
\lettrine{A}{nne,} comme l'Ancien Testament nous le rapporte,
 ...
 Elle dit à Éli, le grand prêtre\frcolon{} \punct{deux-points, majuscule}
 \Og Je suis une femme à l'esprit affligé mais j'épanchais mon âme
 devant l'Éternel. \Fg{}
 Eli lui répondit\frcolon{} \punct{deux-points}
...
\jrnlday{Comment donc devrions-nous vivre ?}
...
\lettrine{É}{tant donné} qu'un jour l'univers matériel va complètement
 ...
 matérielles, des choses destinées à brûler. Paul a écrit\frcolon{} \punct{deux-points}
...
Aussi, quel genre de personnes devrions nous être? Au verset
 \ibiblevs{IIP}(3:14),
 Pierre déclare\frcolon{} \punct{deux-points}
...
Amos, s'est exclamé\frcolon{} \punct{deux-points}
...
\jrnlday{Pas de ténèbres}

\dvquote{%
Voici le message que nous avons entendu de Lui et que nous vous annon\c{c}ons\frcolon{}
...
Il y a, soit de la lumière, soit de l'obscurité, mais vous ne pouvez pas
 ...
 Comme Paul le demandait\frcolon{} \punct{deux-points, guillemets en trop}
...
\lettrine{P}{arce que} nous sommes Ses enfants,
 ...
 Comme Sa Parole nous le dit\frcolon{} \punct{deux-points}
...
La preuve, c'est le Fils de Dieu allant de son plein gré à la croix,
 ...
 l'Amour en personne, et vous pouvez dire avec Jean\frcolon{} \punct{deux-points}
...
Dieu ne se découvre pas par quête intellectuelle, mais par révélation écrite
 ...
 Quand Il priait pour les disciples, Jésus a dit\frcolon{} \punct{deux-points}
 \Og Sanctifie-les par Ta vérité\frcolon{} Ta Parole est la vérité \Fg{} \punct{Point en trop, guillemet manquant}
...
Jean dit de Diotrèphe qu'il \Og aime à être le premier parmi eux. \Fg{}
 Jésus avait dit\frcolon{} \punct{deux-points}
...
\jrnlday{Maintenez-vous dans l'amour de Dieu}
...
\Og Rappelle-toi donc d'où tu es tombé, repens-toi
 ...
 Puis Il a dit\frcolon{} \punct{deux-points} \Og Repens-toi \Fg{}.
 La Bible nous dit que la tristesse selon Dieu, produit la repentance.
 Et la repentance implique un changement. Enfin, Jésus a dit\frcolon{} \punct{deux-points}
...
\jrnlday{Qui est digne?}

\dvquote{%
Et je vis un ange puissant qui proclamait d'une voix forte\frcolon{}
...
Quand Jean réalise que personne n'a été trouvé digne de racheter
 ...
 Mais c'est alors qu'un ancien lui dit\frcolon{} \punct{deux-points}
...
Ce n'est plus qu'une question de temps avant que ce rachat n'arrive
 et que Jésus ne s'avance pour rompre les sceaux et déclarer\frcolon{} \punct{deux-points}
...
\jrnlday{L'homme de péché}

\mainthemeindex{peche@péché}
\themeindex{Antechrist@Antéchrist}
...
Israël est mûre aujourd'hui pour cette imposture. Ils attendent leur Messie.
 Si vous leur demandez\frcolon{} \punct{deux-points}
 \Og À quoi reconnaîtrez-vous votre Messie? \Fg{},
 leur réponse toute faite est\frcolon{} \punct{deux-points}
...
Heureusement, nous \ocadr l'épouse de Christ \fcadr{} ne serons pas là
 ...
 et méprisent
 la vérité souffriront vraiment des conséquences de leur choix. 
...
\jrnlday{Le parfum de la prière}
...
Dans le passage d'aujourd'hui, nous le voyons en train de se faire battre
 ...
 si vous appartenez à Dieu. Comme Jésus l'a promis à Pierre\frcolon{} \punct{deux-points}
...
\jrnlday{Grandes et admirables\dots{}}
...
Concernant notre \Og propre justice \Fg{}, c'est-à-dire la justice
 qui viendrait de nous-mêmes, Ésaïe a dit\frcolon{} \punct{deux-points}
...
La Parole nous dit que \Og nous
 ...
 (\ibibleverse{IJn}(2:1)).
 Ce jour-là, Jésus s'approchera et dira\frcolon{} \punct{deux-points}
...
\jrnlday{La fidèle et~vraie Parole~de~Dieu}

\punct{Pas de point dans le titre}

\dvquote{%
Celui qui était assis sur le trône dit\frcolon{}
...
Dans le chapitre \ibiblechvs{Ez}(36:) du livre d'Ézechiel, Dieu a prophétisé
 ...
 Dieu a dit\frcolon{} \punct{deux-points}
...
Quand Jésus annon\c{c}ait à Ses disciples les évènements
 qui allaient arriver à la fin des âges, Il a dit\frcolon{} \punct{deux-points}
...
\jrnlday{L'invitation de Dieu}

\dvquote{%
L'Esprit et l'épouse disent\frcolon{}
 Viens ! Que celui qui entend, dise\frcolon{} Viens ! \\
...
\lettrine{C}{e livre merveilleux}
 ...
 se termine par une invitation\frcolon{} \punct{deux-points}
 \Og Que celui qui entend, dise\frcolon{} \punct{deux-points}
...
\Og Que celui qui a soif, vienne. \Fg{}
 ...
 quand il disait\frcolon{} \punct{deux-points}
