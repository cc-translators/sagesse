...
\dvlettrine{L}{es graines sont vivantes.}
...
\dvlettrine{J}{usqu'à ce qu'ils développent l'épée à double tranchant,}
...
\dvlettrine{J}{ésus a appris l'obéissance} et Son obéissance
 L'a fait souffrir.
...
\dvlettrine{À}{ moins d'être amarré à quelque chose de solide,}
...
\dvlettrine{L}{a phrase~:} \punct{deux-points}
...
\dvlettrine{P}{arce qu'Il désirait une relation avec Son peuple,}
...
\dvlettrine{T}{out comme la mort,} le jugement de Dieu est inévitable.
...
\dvlettrine{S}{acrifice signifie donner quelque chose de valeur.}
...
\dvday{La Mise à l\ap{}Épreuve de Votre Foi}
...
\dvlettrine{P}{endant la construction de la navette spatiale,}
...
\dvlettrine{I}{l faut deux rames pour ramer.}
...
\dvlettrine{O}{h, les dégâts que la langue peut provoquer!}
