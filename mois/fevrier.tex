...
\dvprayer{
Père, puisse Ton Esprit Saint \suggest{ou Esprit-Saint?}
 défier nos cœurs avec la vérité de Ta Parole.
...
\dvday{L\ap{}Incertitude du Lendemain}
...
\dvday{La Puissance de Dieu}

\dvquote{
Alors Josué parla à l'Éternel, le jour où l'Éternel livra les Amoréens
 aux Israélites, et il dit en présence d'Israël~:
...
}{\bibleverse{Jos}(10:12-13)}

\dvlettrine{L}{es Israélites} s'étaient bien battus
...
Dieu veut que nous fassions de notre mieux
 et que nous confions le reste à Dieu.
}
...
C'est ainsi que l'Éternel donna à Israël tout le pays qu'Il avait juré
 ...
 aucune ne resta sans effet~: toutes s'accomplirent.
}{\bibleverse{Jos}(21:43-45)}

\dvlettrine{Q}{uel puissant} témoignage est ainsi apporté
...
}{\bibleverse{Jos}(24:14) \KJF}

\dvlettrine{L}{es enfants} d'Israël avaient commencé à servir d'autres dieux.
...
Dans le \bibleverse{Dt}, Moïse a demandé~:
...
\dvday{Le Seul Choix Judicieux}

\dvquote{
\dots{} choisissez aujourd'hui qui vous voulez servir~:
...
}{\bibleverse{Jos}(24:15)}

\dvlettrine{D}{ans les moments} de prospérité,
...
}{\bibleverse{Judges}(1:7)}

\dvlettrine{A}{doni-Bézeq} était un roi puissant.
...
Dans le Nouveau Testament nous lisons~:
 ...
 Ce qu'un homme aura semé, il le moissonnera aussi \fg{} (\bibleverse{Gal}(6:7)).
...
\dvprayer{
Aide-nous Seigneur à semer de bonnes semences dans les cœurs
...
\dvday{Le Péché de ne Rien Faire}
...
}{\bibleverse{Judges}(5:23)}

\dvlettrine{L}{'ange} de l'Éternel prononça une sévère malédiction sur Méroz
...
Dieu a appelé son peuple à l'action. Vous avez été sauvés pour servir.
 ...
 en vous abusant par de faux raisonnements \fg{} (\bibleverse{James}(1:22)).
...
Jésus a dit~:
 ...
 c'est celui qui M'aime \fg{} (\bibleverse{Jn}(14:21)).
...
\dvprayer{
Père, nous prions pour que Ton Esprit Saint \suggest{ou Esprit-Saint?}
...
\dvday{L\ap{}Armée de Dieu}

\dvquote{
L'Éternel dit à Gédéon~:
 C'est par les trois cents hommes qui ont lapé,
 que je vous sauverai et que je livrerai Madian entre tes mains. 
}{\bibleverse{Judges}(7:7)}

\dvlettrine{D}{ieu} a réduit le nombre des hommes de Gédéon
...
\dvday{Se Détourner et Servir}

\dvquote{
Les Israélites dirent à l'Éternel~:
...
}{\bibleverse{Judges}(10:15-16)}

\dvlettrine{I}{sraël} avait abandonné Dieu.
...
Dieu a répondu en leur disant~:
 ...
 Dans \bibleverse{Gn}(6:3), Dieu avait prévenu~:
...
\dvbox{
Comme \bibleverse{IJn}(1:9) nous le dit~:
...
Seigneur, Merci de continuer à contester aujourd'hui avec les hommes
 et les femmes. Aide-nous à Te soumettre nos coeurs. 
}{\DlNdJ}
...
\dvquote{
Jephté fit un vœu à l'Éternel et dit~:
...
}{\bibleverse{Judges}(11:30-31,35)}

\dvlettrine{J}{ephté} avait prononcé un terrible vœu.
...
\dvbox{
Certains vœux devraient simplement ne pas être respectés.
 Mais il est d'autres vœux sur lesquels vous ne pouvez pas revenir.
}
...
\dvday{Le Secret de la Force}

\dvquote{
Dalila dit à Samson~:
 Révèle-moi, je te prie, d'où vient ta grande force,
 et avec quoi il faudrait te lier pour te dompter. 
}{\bibleverse{Judges}(16:6)}

\dvlettrine{L}{a force} de Samson était devenue légendaire.
...
\dvquote{
Alors Booz dit aux anciens et à tout le peuple~:
...
}{\bibleverse{Rt}(4:9-10)}

\dvlettrine{S}{elon} la loi juive, si un homme marié mourrait
...
Elle fit un vœu et dit~:
 ...
 et si Tu donnes un garçon à Ta servante, je le donnerai à l'Éternel
 pour tous les jours de sa vie, et le rasoir ne passera pas sur sa tête. \fg{}
}{\bibleverse{ISam}(1:11)}

\dvlettrine{A}{nne} désirait un fils afin de pouvoir être libérée
...
Père, permets-nous d'être en parfaite harmonie avec Ton but et Tes désirs.
 ...
 où Tu peux mettre en œuvre et accomplir Ta volonté. 
}{\DlNdJ}
...
\dvday{Touchés par Dieu}

\dvquote{
Saül s'en alla aussi chez lui à Guibéa.
 Il fut accompagné par les hommes de valeur, dont Dieu avait touché le cœur.
}{\bibleverse{ISam}(10:26)}

\dvlettrine{Q}{ue signifie} avoir votre cœur touché par Dieu ?
...
Comment Dieu touche-t-Il votre coeur ?
...
\dvbox{
Quand Dieu touche votre cœur, il le remplit d'amour et de paix.
...
\dvprayer{
Merci, Père, pour Ton Saint-Esprit qui touche nos cœurs
 et nous pose des défis par l'intermédiaire de la Parole.
 Touche les cœurs de Ton peuple aujourd'hui. 
}{\Amen}
...
}{\bibleverse{ISam}(15:2-3)}

\dvlettrine{L}{es Amalécites} étaient probablement le peuple le plus violent,
...
}{\bibleverse{ISam}(17:45)}

\dvlettrine{C}{haque jour,} ce géant dénommé Goliath arrivait
...
David ne plaçait pas sa confiance en lui-même, mais dans le Seigneur.
...
\dvquote{
David fit encore ce serment~:
 \og Ton père sait bien que j'ai obtenu ta faveur et il aura dit~:
 Que Jonathan ne le sache pas ; cela lui ferait de la peine.
 Mais, aussi vrai que l'Éternel est vivant et que tu es vivant,
 il n'y a qu'un pas entre moi et la mort! \fg{}
}{\bibleverse{ISam}(20:3)}

\dvlettrine{D}{avid} venait d'échapper à la mort.
...
}{\bibleverse{ISam}(22:2)}

\dvlettrine{D}{ieu} a oint David pour être roi.
...
\dvbox{
Dieu recherche des hommes et des femmes qui ont le cœur ouvert et disponible,
 ceux qui veulent Lui dire~:
...
Père, nous Te remercions d'assembler autour de Toi ceux que Tu as choisis.
 Forme-nous et façonne-nous pour être ces personnes que Tu veux que nous soyons
...
}{\bibleverse{ISam}(26:21)}

\dvlettrine{J}{aloux} de la popularité de David, Saül cherchait à le tuer.
