...
Cette prophétie du Deutéronome a été accomplie en Jésus-Christ.
 Paul nous dit dans \bibleverse{ITm} qu'il y a un seul Dieu
...
\begin{enumerate}[(1)]% arabic numbers within brackets
  ...
  \item Dieu est votre refuge. Un refuge est un abri,
   ...
   le juste y court et s'y trouve hors d'atteinte (\bibleverse{Pr}(18:10));
...
Comme Paul l'a dit~:
 \og Si Dieu est pour nous, qui sera contre nous ? \fg{} (\bibleverse{Rm}(8:31)).
...
Faux ! Les Écritures nous disent~:
 ...
 et c'est lui qui aplanira tes sentiers \fg{} (\bibleverse{Pr}(3:5-6)).
...
Dans le Nouveau Testament nous lisons~:
 ...
 Ce qu'un homme aura semé, il le moissonnera aussi \fg{} (\bibleverse{Ga}(6:7)).
...
Dieu a appelé son peuple à l'action. Vous avez été sauvés pour servir.
 ...
 en vous abusant par de faux raisonnements \fg{} (\bibleverse{Jc}(1:22)).
