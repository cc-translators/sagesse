...
\dvbox{%
  Un jour, des hommes demandaient à Jésus: \Og Que devons-nous faire
  pour accomplir les \oe{}uvres de Dieu? \Fg{}
  Jésus leur répondit: \Og L'\oe{}uvre de Dieu, c'est que vous mettiez
...
\lettrine{D}{eux} domaines existent: celui des choses secrètes
...
Josué [\dots{}] leva les yeux et regarda:
 ...
 Il dit: \Og Non, mais je suis le chef de l'armée de l'Éternel,
...
\dvbox{%
Nous sommes souvent contrariés par l'idée que des gens
 sont en train d'échapper aux conséquences de leurs mauvaises actions.
 Mais sachons bien que, tôt ou tard, leurs péchés vont les rattraper.
}

La loi qui décrète que vouz allez récolter ce que vous avez semé est une loi inéluctable.
...
Peut-être votre passé est-il sombre et lamentable,
 ...
 afin que vous puissiez récolter la gloire de l'amour
...
\dvquote{%
Jephté fit un v\oe{}u à l'Éternel et dit:
...
Seigneur, aide-nous à ne pas flirter avec le danger;\\
 puissions-nous nous, au contraire, nous consacrer pleinement et entièrement à Toi. 
}{\Amen}
...
\mainthemeindex{redemption@rédemption}
\themeindex{esclavage}
\themeindex{mariage}
...
Le champ dans cette parabole est le monde, et Jésus est Celui
 ...
 Aussi incroyable que cela paraisse, le trésor c'est\dots{} vous et moi
...
J'attends ce déménagement avec impatience.
 Car voyez-vous, bien que je ne L'aie pas encore vu,
...
Quand le mécontentement vous amène à un engagement total envers Jésus-Christ,
 c'est un bon mécontentement parce qu'il va vous conduire à progresser.
...
Saül avait beaucoup d'atouts naturels dans la vie,
 ...
 ou recherche la direction de la part d'êtres spirituels incertains.
