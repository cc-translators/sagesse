...
\jrnlday{Pratique du~tir à~l'arc}
...
\jrnlday{Laissez-vous simplement~aller}
...
\jrnlday{Plus que nous ne~demandons}
...
\jrnlday{Le respect ne~suffit~pas}
...
\jrnlday{Se mêler de ce qu'il~ne~faut~pas}
...
\jrnlday{Raison du déclin des~Nations}
...
\jrnlday{Mettre notre maison en~ordre}
...
\jrnlday{Fais de ton mieux et confie~le~reste~à~Dieu}
...
\jrnlday{Que l'Éternel soit~avec~toi !}
...
\jrnlday{Plus grand que tous~les~autres~dieux}
...
\jrnlday{Choisissez votre chemin avec~soin}
