...
\diaryday{Pratique du~tir à~l'arc}

\dvquote{
Ainsi [David] ordonna d’enseigner aux enfants de Judah,
 l’usage de l’arc\dots{}
}{\ibibleverse{IIS}(1:18) \KJF}

\lettrine{Q}{uand} David re\c{c}u la nouvelle de la mort
 ...
 là à pleurer.
 Une des fa\c{c}ons dont David réagit à son deuil fut d'ordonner
...
C'était un mémorial particulièrement approprié pour Jonathan.
 ...
 de l'enseigner à tous leurs enfants. De cette fa\c{c}on,
...
Quelquefois quand nous avons tant témoigné de notre foi auprès d'êtres chers,
 ...
 L'Esprit commence à travailler dans leurs c\oe{}urs alors que nous,
 par la prière, lions l'\oe{}uvre de l'ennemi.
...
\diaryday{Qui suis-je ?}

\dvquote{
Alors le roi David alla se présenter devant l'Éternel et dit\frcolon{}\\
 \Og Qui suis-je, Seigneur Éternel, et qu'est-ce que ma maison,
 pour que Tu m'aies fait parvenir jusqu'ici? \Fg{}
}{\ibibleverse{IIS}(7:18)}

\lettrine{C}{'est Nathan,} le prophète, qui rapporta à David
 les paroles de Dieu.
...
Comme David, vous vous dites peut-être\frcolon{}
...
\diaryday{Le Dieu qui~cherche}

\dvquote{
David lui dit\frcolon{}
...
\diaryday{Confession et~pardon}

\dvquote{
David dit à Nathan\frcolon{}
 \Og J'ai péché contre l'Éternel! \Fg{}\\
 Et Nathan dit à David\frcolon{}
 \Og L'Éternel pardonne ton péché, tu ne mourras pas. \Fg{}
}{\ibibleverse{IIS}(12:13)}
...
Quel soulagement quand ce lourd fardeau de péché s'en va.
 ...
 C'est ce que David décrit dans le \ibibleverse{Ps}(32:)
...
\dvprayer{
Père, nous prions pour que Ton Saint Esprit
 nous parle,
...
Dieu a en effet con\c{c}u un moyen par lequel \Og Ses bannis \Fg{}
...
\dvquote{
Ittaï répondit au roi en ces mots\frcolon{}
 \Og L'Éternel est vivant et mon seigneur le roi est vivant!
 À l'endroit où sera mon seigneur le roi, soit pour mourir,
 soit pour vivre, là aussi sera ton serviteur. \Fg{}
}{\ibibleverse{IIS}(15:21)}
...
Père, nous nous rendons compte que nous étions à un moment des étrangers
 ...
 où nous avons dit\frcolon{} \Og Seigneur, je T'appartiens \Fg{} !
}{\DlNdJ}
...
\diaryday{Laissez-vous simplement~aller}

\dvquote{
Le roi dit à Tsadoq\frcolon{}
 ...
 Mais s'Il dit\frcolon{} Je ne t'agrée plus ! me voici,
 qu'Il me fasse ce qui Lui semblera bon. \Fg{}
}{\ibibleverse{IIS}(15:25-26)}
...
\diaryday{Les promesses de~Dieu}
...
}{\ibibleverse{IR}(8:56) \BFC} 

\lettrine{D}{ans} le chapitre 26 du \bibleverse{Lv},
 Dieu avait promis à Moïse qu'Il donnerait à Son peuple
 la terre promise et que la paix y règnerait.

Dans le verset \ibiblevs{Lv}(26:11) du même chapitre, Dieu avait aussi déclaré\frcolon{}
 \Og J'établirai Mon tabernacle au milieu de vous. \Fg{}
 Ici dans \bibleverse{IR}, Salomon célèbre précisément
...
Je suis tellement excité que Dieu tienne fidèlement parole,
 ...
 Dieu a promis que si je Le re\c{c}ois, j'aurai la vie éternelle. 
...
\diaryday{Plus que nous ne~demandons}

\dvquote{
L'Éternel lui dit\frcolon{}
 ...
 et J'y aurai toujours Mes yeux et Mon c\oe{}ur.
}{\ibibleverse{IR}(9:3)} 

\lettrine{L}{e Dieu} qui a créé cet univers m'aime.
 Il pense à moi et Il m'entend quand je prie.
 Non seulement Il m'entend, mais de fa\c{c}on étonnante, Il me répond.
...
\diaryday{Religion facile}

\dvquote{
Le roi\dots{} fit deux veaux d'or et dit au peuple\frcolon{}\\
 \Og Vous êtes assez montés à Jérusalem !
 Israël, voici tes dieux qui t'ont fait monter du pays d'Égypte. \Fg{}
 Il en pla\c{c}a un à Béthel et il mit l'autre à Dan.
 Ce fut là une occasion de péché\dots{}
}{\ibibleverse{IR}(12:28-30)}

\lettrine{L}{e roi Jéroboam} chercha à créer une religion facile
 pour le peuple. Sa logique était\frcolon{}
...
\diaryday{Nouvelles pénibles}

\dvquote{
Lorsque Ahiya entendit le bruit de ses pas,
 au moment où elle franchissait la porte, il dit\frcolon{}
...
\lettrine{J}{éroboam} avait à un moment créé de faux dieux
 ...
 Au lieu de \c{c}a, il a déguisé sa femme en paysanne
 et l'a envoyée chercher de l'aide auprès d'Ahiya, prophète de Dieu.

\dvbox[0.92\textwidth]{
Comme il est ridicule de penser que nous pouvons
 cacher la vérité à Dieu! 
}
...
Le prophète était aveugle, mais il n'était certainement pas sourd.
 ...
 à la femme de Jéroboam.  Il lui dit\frcolon{}
...
Sachant que Dieu est gracieux et plein de compassion,
 ...
 Mais \c{c}a ne devait pas se passer ainsi. 
...
\dvprayer{
Père, merci pour Ta fidélité dans la fa\c{c}on dont Tu nous traites.
...
\dvquote{
Et Élie s’approcha de tout le peuple et dit\frcolon{}
...
\lettrine{N}{ous} avons tendance à penser aux grands hommes de Dieu
 ...
 et faiblesses que nous, Dieu l'a utilisé d'une puissante fa\c{c}on.
 Et \c{c}a, c'est encourageant. Cela signifie que Dieu peut m'utiliser aussi.
...
\`A ce moment spécifique de sa vie, Élie était si découragé
 ...
 Mais au lieu de Lui répondre honnêtement\frcolon{} \Og Je me cache \Fg{},
...
Nous faisons la même chose. Dieu nous voit nous cacher
 ...
 Au lieu de confesser\frcolon{} \Og Je ne fais rien \Fg{},
 nous commen\c{c}ons à inventer des excuses.
 Et quand vous devenez bon à inventer des excuses,
 vous n'êtes généralement plus bon à rien d'autre. 

Êtes-vous découragés? Si c'est le cas, laissez-moi vous demander\frcolon{}
...
Il y a une vaste différence entre admiration et convoitise.
 Je peux admirer ce que vous avez. Je peux dire\frcolon{}
...
\diaryday{Où est le Dieu d'Élie ?}

\dvquote{
Il prit le manteau qu'Élie avait laissé tomber,
 il en frappa les eaux et dit\frcolon{}
 \Og Où est l'Éternel, le Dieu d'Élie? \Fg{}
 Lui aussi, il frappa les eaux qui se partagèrent \c{c}à et là.
 Élisée passa.
}{\ibibleverse{IIR}(2:14)}
...
Vivant dans un âge de scepticisme, je m'écrie moi aussi\frcolon{}
 \Og Oh Dieu, montre-Toi. Prouve-Toi, Seigneur. \Fg{}
 Mon cri est avec Élisée\frcolon{} Où est le Dieu d'Élie qui peut démontrer
...
\diaryday{Des yeux pour~voir}

\dvquote{
Élisée pria en disant\frcolon{}
 \Og Éternel, ouvre ses yeux, je T'en prie, pour qu'il voie. \Fg{}
 L'Éternel ouvrit les yeux du jeune serviteur qui vit ceci\frcolon{}
 la montagne pleine de chevaux et de chars de feu autour d'Élisée.
}{\ibibleverse{IIR}(6:17)}
...
\lettrine{Q}{uand} Guéhazi, le serviteur d'Élisée, se réveilla
 ...
 Rentrant en courant, il dit à Élisée\frcolon{}
 \Og Nous sommes pris au piège. Nous sommes encerclés. \Fg{}

Élisée répondit\frcolon{}
...
Puisse Dieu ouvrir nos yeux pour voir la puissance qui est à notre
 disposition par l'intermédiaire de Jésus-Christ et de l'Esprit Saint, \suggest{ou Esprit-Saint?}
...
Comme Amatsia, certains d'entre vous se mêlent de choses
 ...
 de la même fa\c{c}on plus tard. Et se mêler de choses inappropriées
...
\diaryday{Raison du déclin des~Nations}
...
Et comme l'homme est ridicule quand il se détourne du Dieu vivant.
 ...
 et en retour, ils n'ont absolument rien re\c{c}u. 
...
Il fit disparaître les hauts lieux, brisa les stèles,
 ...
 brûlé des parfums devant lui\frcolon{} on l'appelait Nehouchtân.
}{\ibibleverse{IIR}(18:14)}
...
\lettrine{P}{endant} son périple dans le désert, Israël s'est plaint
 ...
 Le Seigneur a alors dit à Moïse de fa\c{c}onner un serpent de bronze
...
La foi dans les promesses de Dieu guérissait ceux qui avaient été mordus.
 ...
 que Moïse avait fa\c{c}onné. Quand Ézéchias s'en rendit compte,
 il mit en pièces le serpent de bronze et l'appela \grammar{appela}
 \Og Nehouchtân \Fg{},
...
\diaryday{Mettre notre maison en~ordre}

\dvquote{
En ce temps-là, Ézéchias fut malade à la mort;
 et le prophète Ésaïe, fils d'Amots, vint vers lui, et lui dit\frcolon{}
 Ainsi a dit le Seigneur\frcolon{}
 \Og Mets ta maison en ordre; car tu vas mourir, et tu ne vivras plus. \Fg{}
}{\ibibleverse{IIR}(20:1) \NKJF}
...
\lettrine{I}{l y a} tellement de choses que j'ai l'intention de faire
 ...
 à la sienne\frcolon{} \Og Seigneur, peux-Tu attendre un petit moment? \Fg{}
...
Le jour où je comparaîtrai devant Dieu, je veux pouvoir dire avec Paul\frcolon{}
 \Og J'ai combattu le bon combat, j'ai achevé la course,
 j'ai gardé la foi \Fg{} (\ibibleverse{IITm}(4:7)). 
...
\diaryday{La prière de~Jabez}

\dvquote{
Et Jabez appela le Dieu d’Israël, disant\frcolon{}
...
\diaryday{Un c\oe{}ur résolu}

\dvquote{
\dots{} \numprint{50000}, en état d'aller à l'armée,
 munis pour le combat de toutes les armes de guerre
 et prêts à se ranger au combat d'un c\oe{}ur résolu.
}{\ibibleverse{ICh}(12:34)}
...
David a prié\frcolon{}
 \Og Unifie mon c\oe{}ur \Fg{} (\ibibleverse{Ps}(86:11) \NBS).
 Il connaissait la tendance du c\oe{}ur à dire\frcolon{}
...
\diaryday{Invoquez l'Éternel}

\dvquote{
Invoquez son nom\dots{}
}{\ibibleverse{ICh}(16:8)}

\lettrine{Q}{uel} est le Nom de notre Créateur?
 \Og Dieu \Fg{} n'est pas Son nom; c'est Son titre.
 Quand le nom hébreu pour Dieu est traduit en fran\c{c}ais,
...
\diaryday{Fais de ton mieux et confie~le~reste~à~Dieu}
...
Puis Joab pronon\c{c}a son exhortation à l'attention d'Abishaï.
 Ce qu'il disait, en essence, c'était\frcolon{}
...
\diaryday{Que l'Éternel soit~avec~toi !}
...
\lettrine{A}{lors que} Salomon entreprend la construction
 ...
 Et la première chose que David lui dit est\frcolon{}
...
Je ne sais pas ce que Dieu vous appelle à faire.
 ...
 vous êtes peut-être remplis de désarroi. Peut-être vous dites-vous\frcolon{}
 \Og Je ne pourrais jamais y arriver, Seigneur.
 Tu as certainement choisi la mauvaise personne. \Fg{}

Souvenez-vous de Moïse qui disait\frcolon{}
...
La réponse de Dieu est toujours\frcolon{} \Og Je serai avec toi. \Fg{}
...
\diaryday{Donner à Dieu}

\dvquote{
Le peuple se réjouit de leurs offrandes volontaires,
 car c'était avec un c\oe{}ur sans partage qu'ils s'étaient
 portés volontaires pour l'Éternel;
 et le roi David en eut aussi une grande joie.
}{\ibibleverse{ICh}(29:9)}

\lettrine{L}{es gens} offraient et donnaient de leur plein gré.
 Ce faisant, ils commen\c{c}aient à se réjouir et à louer Dieu.
 Et c'est la fa\c{c}on dont les choses devraient toujours se passer,
...
\diaryday{Plus grand que tous~les~autres~dieux}
...
De la plus simple des cellules au grandiose univers,
 ...
 La question est\frcolon{} domine-t-Il et règne-t-Il sur votre vie
...
Les gens n'ont pas changé. Vivant pour l'instant présent, ils sont devenus
 ...
 un autre. Quand Jésus nous a appelés à Le suivre, Il a dit\frcolon{}
...
\diaryday{La victoire de~Dieu}

\dvquote{
Vous n'aurez pas à y combattre\frcolon{}
 présentez-vous, tenez-vous là, et vous verrez le salut de l'Éternel
 en votre faveur. Juda et Jérusalem, soyez sans crainte et sans effroi\frcolon{}
 demain, sortez à leur rencontre, et l'Éternel sera avec vous!
}{\ibibleverse{IICh}(20:17)}
...
Tôt ou tard, nous rencontrons tous des situations qui nous dépassent.
 ...
 nous avons trois adversaires redoutables\frcolon{} les forces du monde,
...
Quand nous restons tranquilles et laissons Dieu agir,
 c'est Lui qui re\c{c}oit toute la gloire une fois que la bataille est gagnée. 
}
...
Dieu a tant de fa\c{c}ons intéressantes de résoudre nos problèmes!
...
}{\ibibleverse{IICh}(21:6)}

\lettrine{J}{osaphat} fut un bon roi et il amena le peuple
...
Vous pouvez prétendre que regarder les obscénités du monde n'affecte pas
 votre relation avec Dieu. J'en doute. Mais pensez à ceci\frcolon{}
