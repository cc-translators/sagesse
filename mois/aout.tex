...
\lettrine{A}{rrêtés} une fois de plus !
 ...
 Certains des membres du Conseil ressentaient une telle colère
...
Quelle folie que de se battre contre le Seigneur!
 ...
 Comme Ésaïe nous le dit~: \punct{deux-points}
...
Quand Gamaliel a donné son avis, Saül (connu plus tard sous le nom de Paul)
 ...
 Et c'est là qu'il a rencontré Dieu qui lui a demandé~: \punct{deux-points}
...
\dvday{Le Dieu qui voit et~qui~entend}
...
Quelquefois notre concept de Dieu le relègue si loin dans l'univers,
 ...
 Il nous assure~: \og J'ai vu. \fg{} \punct{Point avant guillemet}
...
Les Israélites ont dû bien se demander pourquoi il avait fallu
 ...
 ont appris~: ce que nous percevons comme \og en retard \fg{},
 Dieu le perçoit comme \og exactement à l'heure \fg{}.
...
\lettrine{D}{ieu} accomplissait une grande \oe{}uvre en Samarie.
 ...
 l'ange du Seigneur dit à Philippe de quitter la Samarie
 pour se diriger vers le désert.

Cela ne semble pas logique. Pourquoi Dieu lui demandait-Il de quitter
...
Philippe savait seulement qu'il devait aller, il est donc allé.
 ...
 avec l'Éthiopien dans son chariot que Philippe commença à comprendre
...
Faites-Lui confiance. Tout s'éclaircira par la suite.
...
\lettrine{À}{ la demande} du Seigneur, Pierre transmit ce message à Corneille,
...
Jésus a dit~: \punct{deux-points}
 ...
 Le psalmiste a dit~: \punct{deux-points}
...
Père, aide-nous à arriver au bout de nous-mêmes pour que nous puissions
 nous rendre à Toi et accepter la paix que Tu veux nous donner.
}{\NpDlpNdJ}
...
\lettrine{P}{ierre}, obéissant à un commandement venu directement
 de Jésus-Christ avait violé les traditions des Juifs en entrant
 ...
 Pierre répondit~: \punct{deux-points}
 \og Écoutez, c'est Dieu qui a fait ça. Je ne les ai même pas touchés.
...
\dvday{Attachez-vous au~Seigneur}

\dvquote{
Lorsqu'il fut arrivé et qu'il vit la grâce de Dieu,
 il s'en réjouit et les exhorta tous à rester d'un cœur
 résolu attachés au Seigneur.
}{\ibibleverse{Ac}(11:23)}

\lettrine{L}{'église} de Jérusalem décida d'envoyer Barnabas
 à Antioche pour obtenir un rapport de première main sur le mouvement
...
En tant que chrétiens, nous nous trouvons confrontés au monde,
 à la chair et au diable. La chair va se rebeller contre certaines
 ...
 sont tellement formidables ! Oh, la joie de vivre en proche communion avec Lui,
...
Dieu ne nous donne pas les réponses à ces pourquois.
 ...
 Nous savons que Dieu nous aime de façon suprême.
...
Quand la peine ou la blessure arrive, \suggest{arrivent}
 ...
 fermement à ce que nous savons~:
...
\lettrine{U}{n problème} est apparu dans l'Église \suggest{Église} naissante
 au sujet du salut. La question en jeu était~: \punct{Deux-points, majuscule}
...
Ceux qui pensaient ainsi mettaient un lourd fardeau sur les épaules
 ...
 que le premier concile de l'Église a été convoqué. \punct{Point}
...
Jésus a dit~: \punct{deux-points}
 \og Ce qui est l'œuvre de Dieu, c'est que vous croyiez en Celui
 qu'Il a envoyé \fg{} (\ibibleverse{Jn}(6:29)).
 Dieu a réalisé le salut par la foi afin que personne ne puisse
 se glorifier de ce qu'ils ont fait. Et c'est ce que l'Église \suggest{Église}
